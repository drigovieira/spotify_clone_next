        ...
        <main className="flex-1 p-6">
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
                <a href="#" className="bg-white/5 group rounded flex items-center gap-4 overflow-hidden hover:bg-white/10">
                    <Image src="/album.jpeg" width={104} height={104} alt="Capa do album Live in Texas da banda Linkin Park"/>
            ...
            <h2 className="font-semibold text-3xl mt-10">Made for Rodrigo Vieira</h2>
            <div className="grid grid-cols-7 gap-4 mt-4">
                <a href="" className="bg-white/5 p-3 rounded-md flex flex-col gap-2 hover:bg-white/10">
                    <Image className="w-full" src="/album.jpeg" width={120} height={120} alt="Capa do album Live in Texas da banda Linkin Park"/>
